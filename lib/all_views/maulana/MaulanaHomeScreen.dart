...
import 'package:jamia_madrasa/all_controllers/MaulanaHomeController.dart';
import 'package:jamia_madrasa/themes/app_them_data.dart';
import 'package:jamia_madrasa/utils/list.dart';

class MaulanaHomeScreen extends StatelessWidget {
  const MaulanaHomeScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetX<MaulanaHomeController>(
        init: MaulanaHomeController(),
        builder:(controller){
          return Scaffold(
...
class NavigationDrawer extends StatelessWidget {
  ...
  late MaulanaHomeController controller;
